      ...
      {selectedNote && (
        ...
        >
          ...
          >
            ...
            <div className="w-[400px] h-[400px] max-w-[80vw] max-h-[80vw] overflow-hidden flex items-center justify-center bg-gray-50 rounded-xl border border-gray-200 p-2"> {/* p-4 -> p-2 に縮小 */}
